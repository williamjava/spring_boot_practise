...
public class MysqlGenerator {
    private static String packageName="web";    //文件路径
    private static String authorName="WuHoujian";     //作者
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("root")
                        .setUrl("jdbc:mysql://127.0.0.1:3306/star?characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                ...
                // 自定义 controller 父类
                .setSuperControllerClass("com.gui.star."+packageName+".controller.AbstractController")
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        .setParent("com.gui.star."+packageName)// 自定义包路径
